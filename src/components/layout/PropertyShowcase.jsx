...
const PropertyShowcase = () => {
  ...
  return (
    <section className="relative w-full h-screen bg-cover bg-center flex items-center justify-left text-white">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
          {/* Left side with image and cards */}
          ...
          <div className="flex flex-col justify-center lg:pl-8">
            <div
              className="mb-8 inline-flex rounded-lg bg-[#2D2D2D] p-2 border-1 border-[#888F9F] w-fit"
            >
            ...
            <button
              className="inline-flex w-fit items-center gap-2 rounded-lg bg-[#B7801C] px-6 py-3 font-medium text-white transition-colors hover:bg-amber-700"
            >
              See more
            </button>
          </div>
